...
The certificate is the product. The device is the hardware. A smart water shutoff by itself does not earn the insurance discount. HydroSense issues a carrier-recognized certificate the same day as installation and reissues annually.
...
6. Certificate emailed to you and your insurance agent same day
