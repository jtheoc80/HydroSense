...
export const devices: Record<string, Device> = {
  "moen-flo": {
    ...
    howItWorks:
      "The Moen Flo Shutoff installs on the home's potable main water line and monitors water activity through the manufacturer platform. Depending on device settings and conditions, it can alert the homeowner and close the valve automatically.",
    keyFacts: [
    ...
    bestFor:
      "Homes suited to an inline device where the owner wants whole-home flow-and-pressure monitoring, app visibility, and automatic valve control.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "We verify the potable main-line location, pipe size and material, nearby galvanized piping, valve condition, available installation space, standard power, 2.4 GHz Wi-Fi reach, and any fire-sprinkler or shared-line routing.",
      },
    ],
  },
  "phyn-plus": {
    slug: "phyn-plus",
    name: "Phyn Plus",
    tagline: "Pressure-wave analysis with whole-home monitoring and automatic shutoff.",
    howItWorks:
      "Phyn Plus installs on the main water supply after the primary shutoff and before downstream branches. It uses pressure-based analysis through the manufacturer platform to identify water events, provide alerts, and control the integrated shutoff valve.",
    keyFacts: [
      "Installed on the main supply immediately after the main shutoff and before downstream branches or fixtures",
    ...
    bestFor:
      "Homes suited to an inline device where the owner wants pressure-based whole-home monitoring, plumbing insights, and automatic valve control.",
    officialSite: "https://www.phyn.com",
    detectionMethod: "Pressure-wave analysis",
    setupProfile: "120V power + reliable 2.4 GHz Wi-Fi",
    installType: "Inline on the main supply",
    video: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "We verify the main-line position, pipe size and material, mounting height and environment, outlet distance, Wi-Fi strength, internet availability, valve condition, and any fire-sprinkler or shared-line routing.",
      },
    ],
  },
  streamlabs: {
    ...
    howItWorks:
      "StreamLabs Control installs inline on the main water entry line, uses ultrasonic measurement to monitor flow, and controls an integrated shutoff valve through device settings and the StreamLabs app.",
    keyFacts: [
      ...
      "Not intended for installation on a fire-suppression system and should be installed indoors or in a covered, protected location",
    ...
    installType: "Inline on the main water entry line",
    video: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "We verify pipe diameter, installation order relative to the shutoff and pressure-reducing valve, protected indoor or covered placement, outlet reach, 2.4 GHz Wi-Fi, and confirmation that the line is not a fire-suppression line.",
      },
    ],
  },
  guardian: {
    ...
    howItWorks:
      "Guardian uses point leak detectors that communicate with a motorized controller mounted over an existing compatible quarter-turn valve. When a detector senses water or a configured freezing condition, the controller can close the valve without cutting into the pipe.",
    keyFacts: [
      ...
      "This is point-sensor protection rather than whole-home flow or pressure analysis",
    ],
    bestFor:
      "Homes with a compatible, accessible quarter-turn ball valve where a sensor-based retrofit is preferable to cutting an inline device into the main.",
    ...
    installType: "Retrofit over an existing valve",
    video: {
    ...
    faqs: [
      {
        q: "Can Guardian be installed without cutting the main water line?",
      ...
      },
      {
        ...
        a: "Guardian relies on point sensors placed near toilets, appliances, water heaters, drains, and other risk areas. It does not analyze all water flow or pressure through the main line in the same way as an inline whole-home monitor.",
      },
    ],
  },
};
