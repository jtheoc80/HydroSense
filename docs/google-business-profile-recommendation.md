...
> HydroSense Texas specializes in professional smart water shutoff installation across Greater Houston. We evaluate the incoming domestic water line, select a compatible system, coordinate plumbing installation, complete device setup, test automatic shutoff operation, and provide an installation record. HydroSense is listed in Phyn's Find a Phyn Pro Directory and supports FloLogic large-line applications. Plumbing execution is performed under RMP M-43057.

The governed string and validated character limit are exported from lib/business/google-business-profile.ts. The description intentionally contains no URL, price, promotion, partner identity, or partner contact path. Recheck Google's official requirements before a future material rewrite.

## Evidence notes

- Phyn program status: Phyn Pro.
- Phyn public corroboration: https://phyn.com/pages/find-a-phyn-pro
- The Phyn directory is evidence, not a HydroSense sameAs profile.
- License publicly verified: license 43057, Master Plumber, Current.
- RMP endorsement, certificate of insurance, contractual relationship, and plumbing execution relationship are verified in the governed internal record.
- The RMP/company relationship is not publicly corroborated.
- Keep public copy partner-neutral: "Plumbing execution is performed under RMP M-43057."
- Do not publish fulfillment-partner names or contact details.
...
| Manufacturer relationship statement | Listed in Phyn's Find a Phyn Pro Directory; supports FloLogic large-line applications. | OWNER VERIFY |
