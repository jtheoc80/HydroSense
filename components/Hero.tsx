...
const stats = [
  { value: "5-15%", label: "Typical discount" },
  { value: "From $999", label: "Installed" },
  { value: "15 min", label: "Quote time" },
];
      ...
      <div className="section-container relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-fog-200 mb-8 max-w-xl leading-relaxed">
              We install a carrier-recognized smart water shutoff, issue the certificate your
              insurer requires, and keep the documentation current at every renewal so the
              discount sticks year after year.
            </p>
        ...
        <div className="grid grid-cols-3 gap-4 mt-16">
          {stats.map((stat) => (
            ...
            >
              <p className="font-mono text-xl sm:text-2xl text-hydro-400">{stat.value}</p>
